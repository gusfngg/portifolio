...
export function Project({ name, date }: ProjectProps) {
  return (
    <Link href={`/projects/${name}`}>
      <div className="border-[1.5px] flex items-center justify-between hover:bg-zinc-100 dark:hover:bg-neutral-900 hover:border-transparent p-4 rounded-lg cursor-pointer">
